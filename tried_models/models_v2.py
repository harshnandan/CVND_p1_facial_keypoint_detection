...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        #(1 x 224 x 224) -> (32 x 220 x 220)
        self.conv1 = nn.Conv2d(1, 32, 5)
        
        #(32 x 220 x 220) -> (32 x 110 x 110)
        self.pool_2_2 = nn.MaxPool2d(2,2)
        
        # batch normalization
        self.batchNorm1 = nn.BatchNorm2d(32)
        
        #(32 x 111 x 111) -> (64 x 107 x 107)
        self.conv2 = nn.Conv2d(32,64,5)
        
        # (64 x 107 x 107) -> (64 x 54 x 54)
        ...
        #(64 x 54 x 54) -> (128 x 50 x 50)
        self.conv3 = nn.Conv2d(64,128,5)
        
        #(128 x 50 x 50) -> (128 x 26 x 26)
        # self.pool2_2 = nn.MaxPool2d(2,2)
        # batch normalization
        self.batchNorm3 = nn.BatchNorm2d(128)
        
        #(128 x 26 x 26) -> (256 x 22 x 22)
        self.conv4 = nn.Conv2d(128,256,5)
        
        #(256 x 22 x 22) -> (256 x 12 x 12)
        # self.pool2_2 = nn.MaxPool2d(2,2)
        # batch normalization
